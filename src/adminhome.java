...
public static int open=0;
    ...
    private void initComponents() {
        ...
        jMenuBar1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "NavigationBox", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 36), new java.awt.Color(0, 51, 204))); // NOI18N
        ...
        jMenu3.setText("See All Question");
        ...
        jMenu5.setText("See All Student Result");
    ...
    private void jMenu1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu1MouseClicked
        ...
        else
        {
            ...
            JOptionPane.showMessageDialog(jf,"There Exist another page");
        }
    ...
    private void jMenu6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu6MouseClicked
        ...
        JFrame jf=new JFrame();
        jf.setAlwaysOnTop(true);
        int a=JOptionPane.showConfirmDialog(jf,"Do you Really Want to logout the page","select",JOptionPane.YES_NO_OPTION);
        if(a==0)
        {
            setVisible(false);
